...
init python:
    # 设置默认字体为思源黑体（支持中文）
    style.default.font = "fonts/SourceHanSansSC-Regular.otf"
    style.say_dialogue.font = "fonts/SourceHanSansSC-Regular.otf"
    style.say_label.font = "fonts/SourceHanSansSC-Regular.otf"
    style.button_text.font = "fonts/SourceHanSansSC-Regular.otf"
    style.choice_button_text.font = "fonts/SourceHanSansSC-Regular.otf"
